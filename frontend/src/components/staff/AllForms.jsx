  ...
  const applyFilters = () => {
    ...
    if (filters.search) {
      ...
      filtered = filtered.filter(form =>
        ...
        form.studentId?.name.toLowerCase().includes(searchLower)
      );
    }
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600">View and manage all forms in your category</p>
        </div>
